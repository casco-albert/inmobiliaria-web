...
<head>
    ...
    <title>BUSINESS - Inmobiliaria</title>
...
<body class="page-contacto">
    <div class="container">
        ...
        <div class="contenedor-contacto">
            ...
            <div class="col formulario">
                <form action="procesar_formulario.php" method="POST">
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="Dirección de Correo" id="email" name="email" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea placeholder="Escriba su consulta" id="mensaje" name="mensaje" required></textarea>
                    </div>
            ...
            <div class="col">
                <iframe src="https://www.google.com/maps?q=-25.514773,-54.6097454&z=17&output=embed" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
